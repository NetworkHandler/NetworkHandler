...
/// HTTP method, and URL. Designed to provide centralized management of common attributes
/// shared across standard and upload request variants.
public struct CommonRequestData: Hashable, @unchecked Sendable, Withable {
